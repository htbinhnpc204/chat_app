...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Lọc (bắt đầu với)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Bắt đầu với</th>
            <th onClick={changeReverseProperties}>Các thuộc tính</th>
          </tr>
        </thead>
        <tbody>
