...
import com.personal.chatapp.security.AuthoritiesConstants;
import com.personal.chatapp.service.MailService;
import com.personal.chatapp.service.UserService;
import com.personal.chatapp.service.dto.AdminUserDTO;
import com.personal.chatapp.web.rest.errors.BadRequestAlertException;
import com.personal.chatapp.web.rest.errors.EmailAlreadyUsedException;
import com.personal.chatapp.web.rest.errors.UsernameAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.personal.chatapp.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            return ResponseEntity.created(new URI("/api/admin/users/" + newUser.getUsername()))
                .headers(
                    HeaderUtil.createAlert(
                        applicationName,
                        "A user is created with identifier " + newUser.getUsername(),
                        newUser.getUsername()
                    )
                )
                .body(newUser);
    ...
    public ResponseEntity<AdminUserDTO> updateUser(
        ...
        return ResponseUtil.wrapOrNotFound(
            updatedUser,
            HeaderUtil.createAlert(applicationName, "A user is updated with identifier " + userDTO.getUsername(), userDTO.getUsername())
        );
    }
    ...
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable("login") @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        return ResponseUtil.wrapOrNotFound(userService.getUserWithAuthoritiesByUsername(login).map(AdminUserDTO::new));
    }
